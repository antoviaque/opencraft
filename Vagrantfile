...
Vagrant.configure(2) do |config|
  ...
  # TODO: Upload this to a public URL
  config.vm.box_url = 'file:///home/antoviaque/dl/vagrant-opencraft-xenial64.box'
  # TODO: Remove the next two lines - only needed with the unofficial xenial
